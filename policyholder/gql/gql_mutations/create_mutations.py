...
class CreatePolicyHolderMutation(BaseHistoryModelCreateMutationMixin, BaseMutation):
    ...
    def _validate_mutation(cls, user, **data):
        ...
        if PolicyHolderServices.check_unique_employer_tin_policy_holder(employer_tin=data['employer_tin']):
            raise ValidationError(_("mutation.ph_employer_tin_duplicated"))
