...
class PolicyHolderInputType(OpenIMISMutation.Input):
    ...
    employer_tin = graphene.String(max_length=128, required=False)
    employer_type = graphene.String(max_length=128, required=False)
    remarks = graphene.String(max_length=500, required=False)
